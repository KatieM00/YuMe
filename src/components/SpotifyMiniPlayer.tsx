...
export default function SpotifyMiniPlayer() {
  ...
  // Render both collapsed badge and expanded player
  return (
    <>
      ...
      {isExpanded && (
        <div className="fixed bottom-4 right-4 md:bottom-4 md:right-4 z-50 w-80 max-w-[calc(100vw-2rem)]">
          <div className="bg-gray-900 rounded-xl border border-gray-700 shadow-2xl overflow-hidden">
            ...
            {/* Controls */}
            {hasMultipleSongs && (
              <div className="p-3 bg-gray-800/50 flex items-center justify-center space-x-4 border-b border-gray-700">
      ...
      {/* Spotify iframe - ALWAYS RENDERED, repositioned off-screen when collapsed */}
      <div
